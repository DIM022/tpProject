...
string socio::getsex()const  {
    return sexo;
}

/**---------------------------------------------------------------------------------------------------*/

string socio::getdir()const  {
     return direccion;
}

/**---------------------------------------------------------------------------------------------------*/

string socio::getnum()const  {
     return num_telefonico;
}

/**---------------------------------------------------------------------------------------------------*/

string socio::getedad()const  {
     return edad;
}

/**---------------------------------------------------------------------------------------------------*/

string socio::getfechaN()const  {
     return fechaN;
}

/**---------------------------------------------------------------------------------------------------*/

string socio::getmail()const  {
    return mail;
}
